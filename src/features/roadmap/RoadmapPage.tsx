...
import { Typography, Button, Drawer, Form, Input, Select, Tag, Space, message, Empty, Col, Row, Popconfirm, Modal, Tooltip, theme } from 'antd';
import { PlusOutlined, EditOutlined, DeleteOutlined, CompassOutlined, SubnodeOutlined } from '@ant-design/icons';
...
function buildTree(items: RoadmapStep[]): LayoutNode[] {
    ...
    const sortFn = (a: LayoutNode, b: LayoutNode) =>
        priOrd[a.item.priority] - priOrd[b.item.priority] || immOrd[a.item.immediacy] - immOrd[b.item.immediacy];
        ...
        <div style={{ overflow: 'auto', borderRadius: 12, border: `1px solid ${isDark ? '#303030' : '#f0f0f0'}`, background: isDark ? '#1a1a1a' : '#fafafa', position: 'relative' }}>
            <div style={{ position: 'relative', minWidth: w, minHeight: h }}>
                ...
                {nodes.map(n => {
                    ...
                    const pc = PRIORITY_COLORS[n.item.priority];
                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                border: `2px solid ${completed ? '#52c41a' : isDark ? '#404040' : '#e8e8e8'}`,
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                                ...
                                <span style={{
                                    ...
                                    whiteSpace: 'nowrap', color: isDark ? '#e6e6e6' : '#262626',
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                <div style={{ display: 'flex', gap: 4 }}>
                                    <Tag color={pc} style={{ margin: 0, fontSize: 10, lineHeight: '16px', padding: '0 4px' }}>{n.item.priority}</Tag>
...
export const RoadmapPage = () => {
    ...
    const openStepDrawer = useCallback((parentId?: string) => {
        setEditingStep(null);
        form.resetFields();
        form.setFieldsValue({ scopeId: currentTab, priority: 'Media', immediacy: 'Mediano plazo', status: 'Pendiente', parentId: parentId || undefined });
        setStepDrawer(true);
    }, [currentTab, form]);
